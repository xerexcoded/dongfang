...
const ApprovalPage = () => {
  ...
  return (
    <section className="w-full min-h-svh py-12 md:py-24 lg:py-32">
      <div className="container grid items-center gap-4 py-8 px-4 md:px-6">
        ...
        <div className="flex flex-col w-[300] gap-4 mx-auto">
          <Input
